...
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.Usuarios') AND name = 'estado')
BEGIN
    ALTER TABLE dbo.Usuarios
        ADD estado INT NOT NULL CONSTRAINT DF_Usuarios_estado DEFAULT 1;
